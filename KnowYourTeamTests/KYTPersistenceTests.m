...
- (void)testReadWrite {
    ...
    [teamMemberList addObject:[[KYTTeamMember alloc] initWithFirstName:@"Dustin" withLastName:@"Landry" withTitle:@"Tech" withPhoto:[UIImage imageNamed:@"PersonImage"]]];
    
    [teamMemberList addObject:[[KYTTeamMember alloc] initWithFirstName:@"Taylor" withLastName:@"Wood" withTitle:@"Tech" withPhoto:[UIImage imageNamed:@"PersonImage"]]];
    
    [teamMemberList addObject:[[KYTTeamMember alloc] initWithFirstName:@"Cameron" withLastName:@"Daigle" withTitle:@"Tech" withPhoto:[UIImage imageNamed:@"PersonImage"]]];
